...
- Fuzz and finish short-read/error propagation in the legacy AIFF, BRR, IFF, and WAV importers before accepting untrusted files as a hardened production claim. DXM has bounded-reader coverage; S3M, DIGI, MOD, BEM, IT, and XM now reject truncated or structurally invalid payloads, while the remaining older importers retain unchecked-read paths.
