...
APP_DIR=${RELEASE_MACOS_DIR}ft2-dxm-macos.app/

TARGET_X86_64=${APP_DIR}Contents/MacOS/ft2-dxm-macos-x86_64
TARGET_ARM64=${APP_DIR}Contents/MacOS/ft2-dxm-macos-arm64
TARGET_UNIVERSAL=${APP_DIR}Contents/MacOS/ft2-dxm-macos
...
codesign -s - --entitlements ft2-dxm.entitlements release/macOS/ft2-dxm-macos.app
