...
#define CB_DX_BASE (CB_TF_BASE + CB_TF_COUNT)
#define CB_DX_COUNT 0
#define CB_MIXER_BASE (CB_DX_BASE + CB_DX_COUNT)
#define CB_MIXER_COUNT 0
#define CB_DSP_BASE (CB_MIXER_BASE + CB_MIXER_COUNT)
#define CB_DSP_COUNT 0
#define CB_MACRO_MAP_BASE (CB_DSP_BASE + CB_DSP_COUNT)
#define CB_MACRO_MAP_COUNT 0
