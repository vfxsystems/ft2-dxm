...
pushButton_t pushButtons[NUM_PUSHBUTTONS] =
{
	...
	*/
	...
	{ 266, 0,  25, 32, 0, 0, NULL,    NULL,    NULL,       toggleInstEditor },
	...
	{ 359, 155, 59, 16, 0, 0, "Mixer",      NULL,    NULL,       pbOpenMixer },
	...
	{ 430, 348, 54, 16, 0, 0, "Chop",           NULL,    NULL,                  pbSampleSlicer },
	...
	{  82, 155, 73, 16, 0, 0, "Settings",        NULL,    NULL,               pbWavSettings },
...
bool testPushButtonMouseDown(void)
{
	...
	/* Determine pushbutton processing range */
	...
	{
		/* Generic system request (non-mixer): limit to reserved buttons */
		start = 0;
		end   = 8;
	}
	else
	{
		/* Normal GUI or mixer screen – full button access */
		start = 0;
		end   = NUM_PUSHBUTTONS;
	}
