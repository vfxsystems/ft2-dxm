...
enum // RADIOBUTTONS
{
	...
	// WAV RENDER TARGET
	RB_WAV_RENDER_TARGET_FILE,
	RB_WAV_RENDER_TARGET_SLOT,
	...
	RB_GROUP_WAV_RENDER_TARGET,
	RB_GROUP_WAV_RENDER_PATH
};

// Append-only ID ranges for designer-driven layouts (do not reorder existing IDs).
#define RB_TF_BASE NUM_RADIOBUTTONS
#define RB_TF_COUNT 0
#define RB_DX_BASE (RB_TF_BASE + RB_TF_COUNT)
#define RB_DX_COUNT 0
#define RB_MIXER_BASE (RB_DX_BASE + RB_DX_COUNT)
#define RB_MIXER_COUNT 0
#define RB_DSP_BASE (RB_MIXER_BASE + RB_MIXER_COUNT)
#define RB_DSP_COUNT 0
#define RB_MACRO_MAP_BASE (RB_DSP_BASE + RB_DSP_COUNT)
#define RB_MACRO_MAP_COUNT 0
