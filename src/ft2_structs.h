...
typedef struct editor_t
{
	...
	bool instrBankSwapped, channelMuted[MAX_CHANNELS], macroMode[MAX_CHANNELS], NI_Play;
...
typedef struct ui_t
{
	...
	// bottom screens
	bool patternEditorShown, instEditorShown, sampleEditorShown, sampleEditorEffectsShown, synthEditorShown, macroMapEditorShown, pattChanScrollShown;
	...
	bool _sampleEditorShown, _advEditShown, _wavRendererShown, _trimScreenShown, _macroMapEditorShown;
	// -------------------------------------------------------------------------
} ui_t;
