...
#define TB_TF_BASE NUM_TEXTBOXES
#define TB_TF_COUNT 0
#define TB_DX_BASE (TB_TF_BASE + TB_TF_COUNT)
#define TB_DX_COUNT 0
#define TB_MIXER_BASE (TB_DX_BASE + TB_DX_COUNT)
#define TB_MIXER_COUNT 0
#define TB_DSP_BASE (TB_MIXER_BASE + TB_MIXER_COUNT)
#define TB_DSP_COUNT 0
#define TB_MACRO_MAP_BASE (TB_DSP_BASE + TB_DSP_COUNT)
#define TB_MACRO_MAP_COUNT 0
...
// Update instrument name textboxes to show TuneFish4 status
