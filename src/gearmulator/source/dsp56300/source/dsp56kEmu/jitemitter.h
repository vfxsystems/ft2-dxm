...
namespace dsp56k
{
	class JitEmitter : public JitBuilder
	{
		...
		asmjit::Label newLabel() { return JitBuilder::newLabel(); }
		asmjit::Label newNamedLabel(const char* _name) { return JitBuilder::newNamedLabel(_name); }
		asmjit::Label newNamedLabel(const char* _name, size_t _nameSize) { return JitBuilder::newNamedLabel(_name, _nameSize); }
